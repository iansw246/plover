...
BASE_LAYOUT: dict[str, KeyCodeInfo] = {
    ...
    "~": KeyCodeInfo(e.KEY_GRAVE, ["shift_l"]),
    "1": KeyCodeInfo(e.KEY_1),
    "!": KeyCodeInfo(e.KEY_1, ["shift_l"]),
    "2": KeyCodeInfo(e.KEY_2),
    "@": KeyCodeInfo(e.KEY_2, ["shift_l"]),
    "3": KeyCodeInfo(e.KEY_3),
    "#": KeyCodeInfo(e.KEY_3, ["shift_l"]),
    "4": KeyCodeInfo(e.KEY_4),
    "$": KeyCodeInfo(e.KEY_4, ["shift_l"]),
    "5": KeyCodeInfo(e.KEY_5),
    "%": KeyCodeInfo(e.KEY_5, ["shift_l"]),
    "6": KeyCodeInfo(e.KEY_6),
    "^": KeyCodeInfo(e.KEY_6, ["shift_l"]),
    "7": KeyCodeInfo(e.KEY_7),
    "&": KeyCodeInfo(e.KEY_7, ["shift_l"]),
    "8": KeyCodeInfo(e.KEY_8),
    "*": KeyCodeInfo(e.KEY_8, ["shift_l"]),
    "9": KeyCodeInfo(e.KEY_9),
    "(": KeyCodeInfo(e.KEY_9, ["shift_l"]),
    "0": KeyCodeInfo(e.KEY_0),
    ")": KeyCodeInfo(e.KEY_0, ["shift_l"]),
    "-": KeyCodeInfo(e.KEY_MINUS),
    "_": KeyCodeInfo(e.KEY_MINUS, ["shift_l"]),
    "=": KeyCodeInfo(e.KEY_EQUAL),
    "+": KeyCodeInfo(e.KEY_EQUAL, ["shift_l"]),
...
LAYOUTS = {
    ...
    "qwerty": {
        **BASE_LAYOUT,
        ...
        "Q": KeyCodeInfo(e.KEY_Q, ["shift_l"]),
        "w": KeyCodeInfo(e.KEY_W),
        "W": KeyCodeInfo(e.KEY_W, ["shift_l"]),
        "e": KeyCodeInfo(e.KEY_E),
        "E": KeyCodeInfo(e.KEY_E, ["shift_l"]),
        "r": KeyCodeInfo(e.KEY_R),
        "R": KeyCodeInfo(e.KEY_R, ["shift_l"]),
        "t": KeyCodeInfo(e.KEY_T),
        "T": KeyCodeInfo(e.KEY_T, ["shift_l"]),
        "y": KeyCodeInfo(e.KEY_Y),
        "Y": KeyCodeInfo(e.KEY_Y, ["shift_l"]),
        "u": KeyCodeInfo(e.KEY_U),
        "U": KeyCodeInfo(e.KEY_U, ["shift_l"]),
        "i": KeyCodeInfo(e.KEY_I),
        "I": KeyCodeInfo(e.KEY_I, ["shift_l"]),
        "o": KeyCodeInfo(e.KEY_O),
        "O": KeyCodeInfo(e.KEY_O, ["shift_l"]),
        "p": KeyCodeInfo(e.KEY_P),
        "P": KeyCodeInfo(e.KEY_P, ["shift_l"]),
        "[": KeyCodeInfo(e.KEY_LEFTBRACE),
        "{": KeyCodeInfo(e.KEY_LEFTBRACE, ["shift_l"]),
        "]": KeyCodeInfo(e.KEY_RIGHTBRACE),
        "}": KeyCodeInfo(e.KEY_RIGHTBRACE, ["shift_l"]),
        "\\": KeyCodeInfo(e.KEY_BACKSLASH),
        "|": KeyCodeInfo(e.KEY_BACKSLASH, ["shift_l"]),
        # Second row
        "a": KeyCodeInfo(e.KEY_A),
        "A": KeyCodeInfo(e.KEY_A, ["shift_l"]),
        "s": KeyCodeInfo(e.KEY_S),
        "S": KeyCodeInfo(e.KEY_S, ["shift_l"]),
        "d": KeyCodeInfo(e.KEY_D),
        "D": KeyCodeInfo(e.KEY_D, ["shift_l"]),
        "f": KeyCodeInfo(e.KEY_F),
        "F": KeyCodeInfo(e.KEY_F, ["shift_l"]),
        "g": KeyCodeInfo(e.KEY_G),
        "G": KeyCodeInfo(e.KEY_G, ["shift_l"]),
        "h": KeyCodeInfo(e.KEY_H),
        "H": KeyCodeInfo(e.KEY_H, ["shift_l"]),
        "j": KeyCodeInfo(e.KEY_J),
        "J": KeyCodeInfo(e.KEY_J, ["shift_l"]),
        "k": KeyCodeInfo(e.KEY_K),
        "K": KeyCodeInfo(e.KEY_K, ["shift_l"]),
        "l": KeyCodeInfo(e.KEY_L),
        "L": KeyCodeInfo(e.KEY_L, ["shift_l"]),
        ";": KeyCodeInfo(e.KEY_SEMICOLON),
        ":": KeyCodeInfo(e.KEY_SEMICOLON, ["shift_l"]),
        "'": KeyCodeInfo(e.KEY_APOSTROPHE),
        "\"": KeyCodeInfo(e.KEY_APOSTROPHE, ["shift_l"]),
        # Third row
        "z": KeyCodeInfo(e.KEY_Z),
        "Z": KeyCodeInfo(e.KEY_Z, ["shift_l"]),
        "x": KeyCodeInfo(e.KEY_X),
        "X": KeyCodeInfo(e.KEY_X, ["shift_l"]),
        "c": KeyCodeInfo(e.KEY_C),
        "C": KeyCodeInfo(e.KEY_C, ["shift_l"]),
        "v": KeyCodeInfo(e.KEY_V),
        "V": KeyCodeInfo(e.KEY_V, ["shift_l"]),
        "b": KeyCodeInfo(e.KEY_B),
        "B": KeyCodeInfo(e.KEY_B, ["shift_l"]),
        "n": KeyCodeInfo(e.KEY_N),
        "N": KeyCodeInfo(e.KEY_N, ["shift_l"]),
        "m": KeyCodeInfo(e.KEY_M),
        "M": KeyCodeInfo(e.KEY_M, ["shift_l"]),
        ",": KeyCodeInfo(e.KEY_COMMA),
        "<": KeyCodeInfo(e.KEY_COMMA, ["shift_l"]),
        ".": KeyCodeInfo(e.KEY_DOT),
        ">": KeyCodeInfo(e.KEY_DOT, ["shift_l"]),
        "/": KeyCodeInfo(e.KEY_SLASH),
        "?": KeyCodeInfo(e.KEY_SLASH, ["shift_l"]),
    },
    "qwertz": {
        **BASE_LAYOUT,
        # Number row
        ...
        "?": KeyCodeInfo(e.KEY_MINUS, ["shift_l"]),
        "`": KeyCodeInfo(e.KEY_EQUAL, ["shift_l"]),
        "\b": KeyCodeInfo(e.KEY_BACKSPACE),
        # Top row
        "q": KeyCodeInfo(e.KEY_Q),
        ...
        "Ü": KeyCodeInfo(e.KEY_LEFTBRACE, ["shift_l"]),
        "+": KeyCodeInfo(e.KEY_RIGHTBRACE),
        "*": KeyCodeInfo(e.KEY_RIGHTBRACE, ["shift_l"]),
        "#": KeyCodeInfo(e.KEY_BACKSLASH),
        "'": KeyCodeInfo(e.KEY_BACKSLASH, ["shift_l"]),
        ...
        "Ö": KeyCodeInfo(e.KEY_SEMICOLON, ["shift_l"]),
        "ä": KeyCodeInfo(e.KEY_APOSTROPHE),
        "Ä": KeyCodeInfo(e.KEY_APOSTROPHE),
        # Bottom row
        "y": KeyCodeInfo(e.KEY_Z),
        "Y": KeyCodeInfo(e.KEY_Z, ["shift_l"]),
        "x": KeyCodeInfo(e.KEY_X),
        "X": KeyCodeInfo(e.KEY_X, ["shift_l"]),
        "c": KeyCodeInfo(e.KEY_C),
        "C": KeyCodeInfo(e.KEY_C, ["shift_l"]),
        ...
        ">": KeyCodeInfo(e.KEY_DOT, ["shift_l"]),
        "-": KeyCodeInfo(e.KEY_SLASH),
        "_": KeyCodeInfo(e.KEY_SLASH, ["shift_l"]),
    },
    "colemak": {
        **BASE_LAYOUT,
        # Top row
        ...
        "F": KeyCodeInfo(e.KEY_E, ["shift_l"]),
        "p": KeyCodeInfo(e.KEY_R),
        "P": KeyCodeInfo(e.KEY_R, ["shift_l"]),
        "g": KeyCodeInfo(e.KEY_T),
        "G": KeyCodeInfo(e.KEY_T, ["shift_l"]),
        "j": KeyCodeInfo(e.KEY_Y),
        "J": KeyCodeInfo(e.KEY_Y, ["shift_l"]),
        "l": KeyCodeInfo(e.KEY_U),
        "L": KeyCodeInfo(e.KEY_U, ["shift_l"]),
        "u": KeyCodeInfo(e.KEY_I),
        "U": KeyCodeInfo(e.KEY_I, ["shift_l"]),
        "y": KeyCodeInfo(e.KEY_O),
        "Y": KeyCodeInfo(e.KEY_O, ["shift_l"]),
        ";": KeyCodeInfo(e.KEY_O),
        ":": KeyCodeInfo(e.KEY_O, ["shift_l"]),
        "[": KeyCodeInfo(e.KEY_LEFTBRACE),
        "{": KeyCodeInfo(e.KEY_LEFTBRACE, ["shift_l"]),
        "]": KeyCodeInfo(e.KEY_RIGHTBRACE),
        "}": KeyCodeInfo(e.KEY_RIGHTBRACE, ["shift_l"]),
        ...
        "R": KeyCodeInfo(e.KEY_S, ["shift_l"]),
        "s": KeyCodeInfo(e.KEY_D),
        "S": KeyCodeInfo(e.KEY_D, ["shift_l"]),
        "t": KeyCodeInfo(e.KEY_F),
        "T": KeyCodeInfo(e.KEY_F, ["shift_l"]),
        "d": KeyCodeInfo(e.KEY_G),
        "D": KeyCodeInfo(e.KEY_G, ["shift_l"]),
        "h": KeyCodeInfo(e.KEY_H),
        "H": KeyCodeInfo(e.KEY_H, ["shift_l"]),
        "n": KeyCodeInfo(e.KEY_J),
        "N": KeyCodeInfo(e.KEY_J, ["shift_l"]),
        "e": KeyCodeInfo(e.KEY_K),
        "E": KeyCodeInfo(e.KEY_K, ["shift_l"]),
        "i": KeyCodeInfo(e.KEY_L),
        "I": KeyCodeInfo(e.KEY_L, ["shift_l"]),
        "o": KeyCodeInfo(e.KEY_SEMICOLON),
        "O": KeyCodeInfo(e.KEY_SEMICOLON, ["shift_l"]),
        "'": KeyCodeInfo(e.KEY_APOSTROPHE),
        "\"": KeyCodeInfo(e.KEY_APOSTROPHE, ["shift_l"]),
        # Bottom row
        "z": KeyCodeInfo(e.KEY_Z),
    ...
    "colemak-dh": {
        **BASE_LAYOUT,
        ...
        "X": KeyCodeInfo(e.KEY_Z, ["shift_l"]),
        "c": KeyCodeInfo(e.KEY_X),
        "C": KeyCodeInfo(e.KEY_X, ["shift_l"]),
        "d": KeyCodeInfo(e.KEY_C),
        "D": KeyCodeInfo(e.KEY_C, ["shift_l"]),
        "v": KeyCodeInfo(e.KEY_V),
        "V": KeyCodeInfo(e.KEY_V, ["shift_l"]),
        "z": KeyCodeInfo(e.KEY_B),  # less than-key
        "Z": KeyCodeInfo(e.KEY_B, ["shift_l"]),
        "k": KeyCodeInfo(e.KEY_N),
        "K": KeyCodeInfo(e.KEY_N, ["shift_l"]),
        "h": KeyCodeInfo(e.KEY_M),
        "H": KeyCodeInfo(e.KEY_M, ["shift_l"]),
        ",": KeyCodeInfo(e.KEY_COMMA),
        "<": KeyCodeInfo(e.KEY_COMMA, ["shift_l"]),
        ".": KeyCodeInfo(e.KEY_DOT),
        ">": KeyCodeInfo(e.KEY_DOT, ["shift_l"]),
...
for layout_name, layout in LAYOUTS.items():
    for key, key_info in layout.items():
        for modifier in key_info.modifiers:
            modifier_info = layout[modifier]
            assert len(modifier_info.modifiers) == 0, f"Modifier {modifier} in layout {layout_name} should not have modifiers"
...
XKB_KEY_NAME_TO_ALIASES: dict[str, list[str]] = {
    ...
    "KP_Home": ["kp_home", "kp_7"],
    "KP_Up": ["kp_up", "kp_8"],
    "KP_Prior": ["kp_prior", "kp_9"],
    "KP_Subtract": ["kp_subtract"],
    "KP_Left": ["kp_left", "kp_4"],
    "KP_Begin": ["kp_begin", "kp_5"],
    "KP_Right": ["kp_right", "kp_6"],
    "KP_Add": ["kp_add"],
    "KP_End": ["kp_end", "kp_1"],
    "KP_Down": ["kp_down", "kp_2"],
    "KP_Next": ["kp_next", "kp_3"],
    "KP_Insert": ["kp_insert", "kp_0"],
